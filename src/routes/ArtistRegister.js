...
import logo from '../assets/images/Designer_noBackground.png';
import background from '../assets/images/girl_dark.jpg';
...
const Signup = () => {
    ...
    const signUp = async () => {
        ...
        const response = await makeUnauthenticatedPOSTRequest("/auth/artistregister", data);
        ...
        <div className="flex w-full h-screen" style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            ...
            <div className="w-2/3 flex flex-col items-center justify-center py-5">
                <div className="inputRegion flex flex-col space-y-4">
                    {/* <div className="text-xl semi-bold my-8">Sign up for free to start listening.</div> */}
                    <TextInput
                        label="Email address"
